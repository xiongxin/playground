...
\* BEGIN TRANSLATION (chksum(pcal) = "fc036df0" /\ chksum(tla) = "faec4b43")
...
IncCounter(self) == /\ pc[self] = "IncCounter"
                    /\ counter' = (tmp[self] + IF tmp[self] = 0 THEN 1 ELSE -1)
...
\* Last modified Wed Jan 10 17:26:19 CST 2024 by xiongxin
\* Created Thu Jan 04 19:14:21 CST 2024 by xiongxin
