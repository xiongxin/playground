...
\fl{}\moduleLeftDash\cl{ {\MODULE} TCommit}\moduleRightDash\cl{}
\fl{}
\fl{}
\fl{}\al{3}{0}{}
\fl{}\al{4}{0}{}
\fl{}\al{5}{0}{}
\fl{ {\CONSTANT} RM}\al{6}{2}{%
\@y{\@s{0}%
 The set of participating resource managers, This is Set!
}%
}
\fl{}
\fl{ {\VARIABLE} rmState}\al{8}{2}{%
\@y{\@s{0}%
...
\fl{}\al{13}{0}{}
\fl{}\al{14}{0}{}
 \fl{ rmState \.{\in} [ RM \.{\rightarrow} \{\@w{working} ,\,\@w{prepared}
 ,\,\@w{committed} ,\,\@w{aborted} \} ]}
\fl{}
\fl{}
\fl{}
\fl{ TCInit \.{\defeq} rmState \.{=} [ r \.{\in} RM \.{\mapsto}\@w{working} ]}
\fl{}
\fl{}\al{21}{0}{}
\fl{}\al{22}{0}{}
\fl{}
 \fl{ canCommit \.{\defeq} \A\, r \.{\in} RM \.{:} rmState [ r ] \.{\in}
 \{\@w{prepared} ,\,\@w{committed} \}}
\fl{}
\fl{}\al{26}{0}{}
\fl{}\al{27}{0}{}
\fl{}
 \fl{ notCommitted \.{\defeq} \A\, r \.{\in} RM \.{:} rmState [ r ]
 \.{\neq}\@w{committed}}
\fl{}
\fl{}\al{31}{0}{}
\fl{}\al{32}{0}{}
...
\fl{}\al{37}{0}{}
\fl{}\al{38}{0}{}
 \fl{ Prepare ( r )}\al{39}{4}{ \.{\defeq}}\al{39}{5}{ \.{\land}}\al{39}{6}{
 rmState [ r ] \.{=}\@w{working}}
 \fl{ \.{\land}}\al{40}{1}{ rmState \.{'} \.{=} [ rmState {\EXCEPT} {\bang} [
 r ] \.{=}\@w{prepared} ]}
\fl{}
 \fl{ Decide ( r )}\al{42}{4}{ \.{\defeq}}\al{42}{5}{ \.{\lor}}\al{42}{6}{
 \.{\land}}\al{42}{7}{ rmState [ r ] \.{=}\@w{prepared}}
\fl{ \.{\land}}\al{43}{1}{ canCommit}
 \fl{ \.{\land}}\al{44}{1}{ rmState \.{'} \.{=} [ rmState {\EXCEPT} {\bang} [
 r ] \.{=}\@w{committed} ]}
 \fl{ \.{\lor}}\al{45}{1}{ \.{\land}}\al{45}{2}{ rmState [ r ] \.{\in}
 \{\@w{working} ,\,\@w{prepared} \}}
\fl{ \.{\land}}\al{46}{1}{ notCommitted}
 \fl{ \.{\land}}\al{47}{1}{ rmState \.{'} \.{=} [ rmState {\EXCEPT} {\bang} [
 r ] \.{=}\@w{aborted} ]}
\fl{}
 \fl{ TCNext \.{\defeq} \E\, r \.{\in} RM \.{:} Prepare ( r ) \.{\lor} Decide
 ( r )}
\fl{}
\fl{}\al{51}{0}{}
\fl{}\al{52}{0}{}
\fl{}\midbar\cl{}
\fl{ TCConsistent \.{\defeq}}
\fl{}
\fl{}\al{56}{0}{}
\fl{}\al{57}{0}{}
\fl{}\al{58}{0}{}
 \fl{ \A\, r1 ,\, r2 \.{\in} RM \.{:} {\lnot}}\al{59}{8}{
 \.{\land}}\al{59}{9}{ rmState [ r1 ]}\al{59}{13}{
 \.{=}}\al{59}{14}{\@w{aborted}}
 \fl{ \.{\land}}\al{60}{1}{ rmState [ r2 ]}\al{60}{5}{
 \.{=}}\al{60}{6}{\@w{committed}}
\fl{}\midbar\cl{}
\fl{}
\fl{}\al{63}{0}{}
\fl{}\al{64}{0}{}
\fl{}\al{65}{0}{}
\fl{ TCSpec \.{\defeq} TCInit \.{\land} {\Box} [ TCNext ]_{ rmState}}
\fl{}
\fl{}\al{68}{0}{}
\fl{}\al{69}{0}{}
\fl{}\al{70}{0}{}
\fl{}
 \fl{ {\THEOREM} TCSpec \.{\implies} {\Box} ( TCTypeOK \.{\land} TCConsistent
 )}
\fl{}
\fl{}\al{74}{0}{}
\fl{}\al{75}{0}{}
