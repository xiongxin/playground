...
\fl{ {\p@variables}}
\fl{ acct \.{\in} [ People \.{\rightarrow} Money ] {\p@semicolon}}
\fl{}
\fl{ {\p@define}}
...
\fl{}
 \fl{ \.{\land}}\al{51}{1}{ amnt}\al{51}{2}{ \.{\in}}\al{51}{3}{ [ 1
 \.{\dotdot} NumTransfers}\al{51}{7}{ \.{\rightarrow}}\al{51}{8}{ 1
 \.{\dotdot} 5 ]}
 \fl{ \.{\land}}\al{52}{1}{ from}\al{52}{2}{ \.{\in}}\al{52}{3}{ [ 1
 \.{\dotdot} NumTransfers}\al{52}{7}{ \.{\rightarrow}}\al{52}{8}{ People ]}
 \fl{ \.{\land}}\al{53}{1}{ to}\al{53}{2}{ \.{\in} [ 1 \.{\dotdot}
 NumTransfers \.{\rightarrow} People ]}
 \fl{ \.{\land}}\al{54}{1}{ pc}\al{54}{2}{ \.{=} [ self \.{\in} ProcSet
 \.{\mapsto}\@w{Check} ]}
\fl{}
 \fl{ Check ( self ) \.{\defeq}}\al{56}{5}{ \.{\land}}\al{56}{6}{ pc [ self ]
 \.{=}\@w{Check}}
 \fl{ \.{\land}}\al{57}{1}{ {\IF}}\al{57}{2}{ acct [ from [ self ] ] \.{\geq}
 amnt [ self ]}
 \fl{ \.{\THEN}}\al{58}{1}{ \.{\land}}\al{58}{2}{ pc \.{'}}\al{58}{4}{
 \.{=}}\al{58}{5}{ [ pc {\EXCEPT} {\bang} [ self ]}\al{58}{12}{
 \.{=}}\al{58}{13}{\@w{Withdraw} ]}
 \fl{ \.{\ELSE}}\al{59}{1}{ \.{\land}}\al{59}{2}{ pc \.{'}}\al{59}{4}{
 \.{=}}\al{59}{5}{ [ pc {\EXCEPT} {\bang} [ self ]}\al{59}{12}{
 \.{=}}\al{59}{13}{\@w{Done} ]}
 \fl{ \.{\land}}\al{60}{1}{ {\UNCHANGED} {\langle} acct ,\, amnt ,\, from ,\,
 to {\rangle}}
\fl{}
 \fl{ Withdraw ( self ) \.{\defeq}}\al{62}{5}{ \.{\land}}\al{62}{6}{ pc [ self
 ] \.{=}\@w{Withdraw}}
 \fl{ \.{\land}}\al{63}{1}{ acct \.{'} \.{=} [ acct {\EXCEPT} {\bang} [ from [
 self ] ] \.{=} acct [ from [ self ] ] \.{-} amnt [ self ] ]}
 \fl{ \.{\land}}\al{64}{1}{ pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ self ]
 \.{=}\@w{Deposit} ]}
 \fl{ \.{\land}}\al{65}{1}{ {\UNCHANGED} {\langle} amnt ,\, from ,\, to
 {\rangle}}
\fl{}
 \fl{ Deposit ( self ) \.{\defeq}}\al{67}{5}{ \.{\land}}\al{67}{6}{ pc [ self
 ] \.{=}\@w{Deposit}}
 \fl{ \.{\land}}\al{68}{1}{ acct \.{'} \.{=} [ acct {\EXCEPT} {\bang} [ to [
 self ] ] \.{=} acct [ to [ self ] ] \.{+} amnt [ self ] ]}
 \fl{ \.{\land}}\al{69}{1}{ pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ self ]
 \.{=}\@w{Done} ]}
 \fl{ \.{\land}}\al{70}{1}{ {\UNCHANGED} {\langle} amnt ,\, from ,\, to
 {\rangle}}
\fl{}
...
\fl{}
\fl{}
 \fl{ Terminating \.{\defeq}}\al{75}{2}{ \.{\land}}\al{75}{3}{ \A\, self
 \.{\in} ProcSet \.{:} pc [ self ] \.{=}\@w{Done}}
\fl{ \.{\land}}\al{76}{1}{ {\UNCHANGED} vars}
\fl{}
 \fl{ Next}\al{78}{1}{ \.{\defeq}}\al{78}{2}{ (}\al{78}{3}{ \E\, self \.{\in}
 1 \.{\dotdot} NumTransfers \.{:} wire ( self ) )}
\fl{ \.{\lor} Terminating}
\fl{}
 \fl{ Spec}\al{81}{1}{ \.{\defeq}}\al{81}{2}{ Init \.{\land} {\Box} [ Next ]_{
 vars}}
\fl{}
