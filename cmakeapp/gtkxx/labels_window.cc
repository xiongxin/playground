#include "labels_window.hpp"
#include <iostream>

LabelsWindow::LabelsWindow()
    : m_HBox(Gtk::Orientation::HORIZONTAL, 5),
      m_VBox(Gtk::Orientation::VERTICAL, 5),
      m_VBox2(Gtk::Orientation::VERTICAL, 5), m_Frame_Normal("Normal Lable"),
      m_Frame_Multi("Left Justified Label"),
      m_Frame_Right("Right Justified Lable"),
